...
function appendData(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        modalButton.setAttribute("data-target", '');
        modalButton.innerText = "Details";
        var pCardBody = document.createElement("p");
        pCardBody.innerText = data[i].productName;
        divCardBody.appendChild(pCardBody);
        divCardBody.appendChild(modalButton);
        divCard.appendChild(img);
        divCard.appendChild(divCardBody);
        divCol.appendChild(divCard);
        (_a = productContainer) === null || _a === void 0 ? void 0 : _a.appendChild(divCol);
        /*//creating Modals
